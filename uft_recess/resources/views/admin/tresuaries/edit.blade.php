...
@section('content')
    ...
    {!! Form::model($tresuary, ['method' => 'PUT', 'route' => ['admin.tresuaries.update', $tresuary->id]]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('amount[]', $amounts, old('amount') ? old('amount') : $tresuary->amount->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-amount' , 'required' => '']) !!}
                    <p class="help-block"></p>
